                            ...
                            <div class="panel-group category-products">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="/category/<?= $key['id'];?>"><?= $key['name'];?></a></h4>
                                    </div>
                                </div>
                            <?php endforeach;?>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <a href="/cart/add/<?= $key['id']?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>В корзину</a>
                                        </div>
                                        <? if($key['is_new']):?>
